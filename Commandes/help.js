...
module.exports.run = async(client, message, args) => {
    ...
    .addField('**>** addrole [user] [role]', 'Ajoute le rôle à un utilisateur ⚠️ Problème détecté ne fonctionne que pour soi')
    .addField('**>** delrole [user [role]', 'Retire le rôle à un utilisateur ⚠️ Problème détecté ne fonctionne que pour soi')
    .addBlankField()
